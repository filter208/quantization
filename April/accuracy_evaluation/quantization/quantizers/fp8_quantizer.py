...
class FPQuantizer(QuantizerBase):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.flex_bias = kwargs.pop("flex_bias", None)
    ...
    def forward(self, x_float):
        ...
        if self.flex_bias:
            ...
            self.default_maxval_tensor = torch.full(self.maxval.shape, self.default_maxval, device=self.maxval.device)
            res, self.custom_bias = quantize_to_fp8_ste_MM(
                x_float, self.n_bits, self.default_maxval_tensor, self.mantissa_bits, self.sign_bits
            )
