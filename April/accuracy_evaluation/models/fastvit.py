...
from models.fastvit_modules.mobileone import MobileOneBlock
from models.fastvit_modules.replknet import ReparamLargeKernelConv
...
class RepMixerBlock(nn.Module):
    ...
    def __init__(
        ...
        self.convffn = ConvFFN(
            in_channels=dim,
            hidden_channels=self.mlp_hidden_dim,
            act_layer=act_layer,
            drop=drop,
        )
