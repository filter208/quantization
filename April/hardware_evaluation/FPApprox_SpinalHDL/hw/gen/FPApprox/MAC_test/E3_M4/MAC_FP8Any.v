...
module MAC_FP8Any (
  ...
  wire       [7:0]    Mult_Sum;
  wire       [1:0]    fPAny_LNS_Mult_Comp_DnSp_1_MantComp;
  ...
  FPAny_LNS_Mult_Comp_DnSp fPAny_LNS_Mult_Comp_DnSp_1 (
    ...
    .MantComp (fPAny_LNS_Mult_Comp_DnSp_1_MantComp[1:0])  //o
  );
  fpany_adder_widen #(
    .EXPO_WIDTH_MULT (3),
    .MANT_WIDTH_MULT (4),
  ...
  assign fPAny_LNS_Mult_Comp_DnSp_1_MantX = Iact[3 : 1];
  assign fPAny_LNS_Mult_Comp_DnSp_1_MantY = Wght[3 : 1];
  assign Mult_Z = {4'b1101,tmp_Z};
