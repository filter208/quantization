...
module MAC_FP8Any (
  ...
  wire       [7:0]    Mult_Sum;
  wire       [0:0]    fPAny_LNS_Mult_Comp_DnSp_1_MantComp;
  ...
  FPAny_LNS_Mult_Comp_DnSp fPAny_LNS_Mult_Comp_DnSp_1 (
    ...
    .MantComp (fPAny_LNS_Mult_Comp_DnSp_1_MantComp  )  //o
  );
  fpany_adder_widen #(
    .EXPO_WIDTH_MULT (4),
    .MANT_WIDTH_MULT (3),
  ...
  assign fPAny_LNS_Mult_Comp_DnSp_1_MantX = Iact[2 : 0];
  assign fPAny_LNS_Mult_Comp_DnSp_1_MantY = Wght[2 : 0];
