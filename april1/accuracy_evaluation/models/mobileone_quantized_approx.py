...
from approx.replace_operations_with_approx_ops import quantize_model
...
def mobileone_quantized_approx(pretrained=True, model_dir=None, load_type="fp32", **qparams):
